...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('medium-large', 375, '', true); // Medium-Large Thumbnail
    add_image_size('small', 120, '', true); // Small Thumbnail
    add_image_size('custom-size', 700, 200, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('full-width', 1200, '', true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
//Excerpt that does not truncate last word
